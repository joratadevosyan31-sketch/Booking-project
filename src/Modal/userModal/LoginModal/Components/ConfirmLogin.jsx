...
const ConfirmLogin = ({
  ...
  const phoneNumberRef = useRef(initialPhoneNumber);
  ...
  useEffect(() => {
    ...
    if (!phoneNumberRef.current && storedPhone) {
      phoneNumberRef.current = storedPhone;
    }
  }, []);
  ...
  const handleResendCode = async () => {
    ...
    const phoneToShow =
      phoneNumberRef.current || initialPhoneNumber || "your phone";
    alert(`A new verification code has been sent to ${phoneToShow}`);
  };
