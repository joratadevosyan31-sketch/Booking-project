...
import {
  fetchGetSalonData,
  fetchPatchSalonData,
} from "../../store/slice/SalonDataState/SalonApi";
...
const SalonPage = () => {
  ...
  useEffect(() => {
    ...
    // Only update form data when salonData actually changes and we're not editing
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-[36px] font-bold text-gray-800">Salon Settings</h2>
        {!isEditing ? (
          <Button
            type="primary"
            icon={<EditOutlined />}
      ...
      <div className="border border-gray-300 rounded-[12px] overflow-hidden bg-white shadow-sm">
        ...
        <div className="grid grid-cols-8 items-center text-gray-600 border-t border-gray-200">
