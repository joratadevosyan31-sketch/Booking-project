...
import { clearSelectedSubservices, setProfessional, toggleSubservice } from "../../../../../store/slice/BookingCardDataState/BookingCardDataSlice";
...
const btnSettings = {
    ...
    responsive: [
        ...
        { breakpoint: 639, settings: { slidesToShow: 3, slidesToScroll: 3, initialSlide: 3 } },
    ]
};
...
const SelectAllServices = () => {
    ...
    const handleSelectSubservice = (sub) => {
        ...
        if (firstSubservice) {
            ...
            if (currentServiceId !== newServiceId) dispatch(setProfessional(null));
        } else {
            dispatch(setProfessional(null));
        }
    };
                    ...
                    return (
                        ...
                        >
                            ...
                            <div>
                                <button
                                    type="button"
                                    onClick={(e) => { e.stopPropagation(); handleSelectSubservice(sub); }}
...
export default SelectAllServices;
